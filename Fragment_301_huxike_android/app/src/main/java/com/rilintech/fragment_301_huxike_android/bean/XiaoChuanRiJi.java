 ...
 */
public class XiaoChuanRiJi implements Parcelable {
    ...
    public XiaoChuanRiJi() {
    }

    protected XiaoChuanRiJi(Parcel in) {
    ...
    public static final Parcelable.Creator<XiaoChuanRiJi> CREATOR = new Parcelable.Creator<XiaoChuanRiJi>() {
        @Override
        public XiaoChuanRiJi createFromParcel(Parcel source) {
            return new XiaoChuanRiJi(source);
        }

        @Override
        public XiaoChuanRiJi[] newArray(int size) {
            return new XiaoChuanRiJi[size];
        }
    };
}
